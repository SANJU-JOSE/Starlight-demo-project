...
#     file: ../../assets/Fav-icon.ico
  actions:
    - text: Getting Started
      link: /getting-started/introduction-to-space-exploration/
      icon: right-arrow
...
<CardGrid stagger>
    <Card title="Launch into Orbit" icon="rocket">
        Learn the basics of spacecraft operations → [Introduction to Space Exploration](/getting-started/introduction-to-space-exploration/)
    </Card>
    ...
    <Card title="Master Gravity and Orbit" icon="star">
        Understand the forces that shape your journey → [Dealing with Gravity and Orbit](/cosmic-navigation/dealing-with-gravity-and-orbit/)
    </Card>
</CardGrid>